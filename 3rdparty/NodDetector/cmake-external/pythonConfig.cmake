...
function(find_python_module module)
    ...
    if(NOT PYTHON_${module_upper})
        if(ARGC GREATER 1 AND ARGV1 STREQUAL "REQUIRED")
            ...
            message(STATUS "PYTHON_${module}_FIND_REQUIRED=${PYTHON_${module}_FIND_REQUIRED}")
        endif()
...
# find_python_module(argparse ${REQUIRED_FLAG})
find_python_module(numpy ${REQUIRED_FLAG})
find_python_module(matplotlib ${REQUIRED_FLAG})
# find_python_module(sqlalchemy ${REQUIRED_FLAG})
find_python_module(scipy ${REQUIRED_FLAG})

# A trick, to make FindPythonLibs work in the expected way in the presence of
# externally compiled python versions.
get_filename_component(TTRACK_PYTHON_PREFIX1 ${PYTHON_EXECUTABLE} PATH)
get_filename_component(TTRACK_PYTHON_PREFIX ${TTRACK_PYTHON_PREFIX1} PATH)
set(CMAKE_SYSTEM_PREFIX_OLD ${CMAKE_SYSTEM_PREFIX_PATH}) #memorize old path
set(CMAKE_SYSTEM_PREFIX_PATH "${TTRACK_PYTHON_PREFIX};${CMAKE_SYSTEM_PREFIX_PATH}")
...
set(python_INCLUDE_DIRS "${PYTHON_PREFIX}/include/python${PYTHON_VERSION};${PYTHON_NUMPY_INCLUDE_DIR}" CACHE INTERNAL
