...
#ifndef __IP_HOGFEATUREPRODUCERROUNDED_H__
#define __IP_HOGFEATUREPRODUCERROUNDED_H__
...
class ip_HogFeatureProducerRounded {
...
#endif // __IP_HOGFEATUREPRODUCERROUNDED_H__
